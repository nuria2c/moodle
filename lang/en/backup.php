...
$string['automatednumneverremove'] = 'Number of backups to never remove';
$string['automatednumneverremovehelp'] = 'Choose a minimum number of backups for each course, which should never be removed regardless of how old they are. This requires the \'Remove backups older than\' setting to be enabled.';
$string['automatedremovalsettings'] = 'Automated backup removal settings';
$string['automatedremovedays'] = 'Remove backups older than';
$string['automatedremovedayshelp'] = 'Choose to remove backups older than a number of days.';
