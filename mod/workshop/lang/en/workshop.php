...
$string['allocatecannotassess'] = '<br />can not assess: {$a->cannotassess}';
$string['allocatedetails'] = 'expected: {$a->expected}<br />to allocate: {$a->allocate}<br />submitted: {$a->submitted}';
...
$string['someuserscannotassess'] = 'There is at least one reviewer who can not assess because it has not yet submitted his work';
...
$string['submissionrequired'] = 'You can not asses as long you do not submit your work';
