...
$string['auth_cas_multiauthalternateurl'] = 'If you enter a URL here, it will be used as the multi-authentication page for this site.<br />Leave this setting blank to use the default login page.';
$string['auth_cas_multiauthalternateurl_key'] = 'Alternate multi-authentication URL';
$string['auth_cas_multiauthalternateurl_validation'] = 'If you are not using Multi-authentication you are not able to set an alternate multi-authentication URL';
