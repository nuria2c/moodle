...
$string['coursetotalletter'] = 'Course total in letter';
...
$string['includecoursetotalletter'] = 'Also include the course total in letter';
$string['includecoursetotalletter_help'] = 'If enabled, this option will also include a column for the course total in letter. To be functional, the Grade export display type must not be in letter and the total course grade need to be included.';
