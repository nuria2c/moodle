 ...
 */
define(['jquery', 'core/ajax', 'core/str', 'tool_lp/competencypicker'],
    function($, ajax, Str, Picker) {

    /**
     * Parent Competency Form object.
     * @param {String} buttonSelector The parent competency button selector.
     * @param {String} resetbuttonSelector The reset parent competency button selector.
    ...
    /** @var {String} The reset parent competency button selector. */
    ParentCompetencyForm.prototype.resetbuttonSelector = null;
    ...
    ParentCompetencyForm.prototype.registerEvents = function() {
        var self = this;
        // Event on reset parent button.
        $(self.resetbuttonSelector).on('click', function() {
            // On reset we set the framework as parent.
            Str.get_string('competencyframeworkroot', 'tool_lp').then(function(rootframework) {
                $(self.staticElementSelector).html(rootframework);
                $(self.inputHiddenSelector).val(0);
            });
        });
        // Event on edit parent button.
        $(self.buttonSelector).on('click', function() {
            ...
            picker.on('save', function(e, data) {
                ajax.call([
                    { methodname: 'tool_lp_read_competency', args: {
