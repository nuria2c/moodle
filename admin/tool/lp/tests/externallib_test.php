...
class tool_lp_external_testcase extends externallib_advanced_testcase {
     ...
     */
    public function test_update_plan_status() {
        $syscontext = context_system::instance();
        ...
        $result = external::update_plan_status($plan->id, plan::STATUS_COMPLETE);
        $this->assertTrue($result);

        $result = external::update_plan_status($plan->id, plan::STATUS_ACTIVE);
        $this->assertTrue($result);
    }
