...
$string['completeplan'] = 'Complete this plan';
$string['completeplanconfirm'] = 'Complete plan \'{$a}\'?';
...
$string['reopenplan'] = 'Reopen this plan';
$string['reopenplanconfirm'] = 'Re-open plan \'{$a}\'?';
