...
class competency_framework_deleted extends base {
    ...
    /**
     * Api to Delete new event from competency framework object.
     *
     * @param \stdClass $framework record from DB table 'tool_lp_commpetency_framework'
     * @return \core\event\base returns instance of new event
     */
    public static final function create_from_framework($framework) {
        if (empty($framework->get_id()) || $framework->get_id() == 0) {
